    ...
    <div class="aap-header">
        <div class="aap-header-inner">
            <div class="aap-logo">
                ...
                <span class="aap-logo-badge" style="background: linear-gradient(135deg, #6366f1, #4f46e5);">🗺️ XML Sitemap Controller</span>
            </div>
                ...
                <a href="<?php echo admin_url('admin.php?page=aap-sitemap'); ?>" class="aap-nav-link active">Sitemap Manager</a>
