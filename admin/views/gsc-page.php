...
<div class="aap-wrap">
    ...
    <a href="<?php echo esc_url( admin_url('admin.php?page=aap-gsc') ); ?>" class="aap-nav-link active">Indexing</a>
    ...
    <div class="aap-content">
        ...
        <div class="aap-panel" style="margin-bottom:20px;">
            ...
            <div class="aap-alert aap-alert-warning" style="margin:15px 0 5px;">
                ⚠️ Google Service Account JSON key is not configured. Go to <a href="<?php echo esc_url( admin_url('admin.php?page=aap-settings') ); ?>">Settings → Internal Linking & Indexing</a> to paste or upload your credentials.
            </div>
            <?php else: ?>
            <div class="aap-hint" style="padding: 10px 0 0;">
                ...
                <?php else: ?>
                <br><em>Auto-Ping is OFF</em> — Enable it in <a href="<?php echo esc_url( admin_url('admin.php?page=aap-settings') ); ?>">Settings</a> to auto-submit new posts.
                <?php endif; ?>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="aap-panel">
            <div class="aap-panel-header">
                <h2 class="aap-panel-title">🚀 Request Indexing (Showing <?php echo count($posts); ?> of <?php echo (int) $total_posts; ?>)</h2>
            </div>
